<div x-data="{ showAdvanced: @entangle('showAdvanced') }">
    <div class="flex items-center justify-between pb-4">
        <div>
            <h3 class="font-semibold text-neutral-900 dark:text-white">Swarm Deployment Configuration</h3>
            <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-1">Configure how this application is deployed across the Swarm cluster.</p>
        </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            {{-- Mode & Replicas --}}
            <div class="p-4 rounded-lg bg-white dark:bg-coolgray-200 border border-neutral-200 dark:border-transparent">
                <h4 class="font-medium text-neutral-900 dark:text-white text-sm pb-3">Mode & Replicas</h4>
            ...
            {{-- Update Policy --}}
            <div class="p-4 rounded-lg bg-white dark:bg-coolgray-200 border border-neutral-200 dark:border-transparent">
                <h4 class="font-medium text-neutral-900 dark:text-white text-sm pb-3">Update Policy</h4>
            ...
            {{-- Rollback Policy --}}
            <div class="p-4 rounded-lg bg-white dark:bg-coolgray-200 border border-neutral-200 dark:border-transparent">
                <h4 class="font-medium text-neutral-900 dark:text-white text-sm pb-3">Rollback Policy</h4>
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
            ...
            <div class="p-4 rounded-lg bg-white dark:bg-coolgray-200 border border-neutral-200 dark:border-transparent">
                <div class="flex items-center justify-between pb-3">
                    <h4 class="font-medium text-neutral-900 dark:text-white text-sm">Placement Constraints</h4>
                ...
                @if (count($constraints) === 0)
                    <p class="text-sm text-neutral-600 dark:text-neutral-500">No placement constraints. Tasks can run on any available node.</p>
                @else
                    <div class="space-y-2">
                        @foreach ($constraints as $idx => $constraint)
                            <div class="flex items-center gap-2">
                                ...
                                <select wire:model="constraints.{{ $idx }}.operator"
                                    class="px-2 py-2 text-sm rounded bg-white dark:bg-coolgray-100 border border-neutral-200 dark:border-coolgray-300 text-neutral-900 dark:text-white focus:border-blue-500 focus:outline-none w-20">
                                    <option value="==">==</option>
                                    <option value="!=">!=</option>
                                </select>
                                <x-forms.input
                                ...
                                <button wire:click="removeConstraint({{ $idx }})"
                                    class="px-2 py-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 transition-colors shrink-0">
                ...
                @endif
                <p class="text-xs text-neutral-600 dark:text-neutral-500 mt-2">
                    Common fields: <code class="text-neutral-600 dark:text-neutral-400">node.role</code>,
                    <code class="text-neutral-600 dark:text-neutral-400">node.hostname</code>,
                    <code class="text-neutral-600 dark:text-neutral-400">node.labels.&lt;key&gt;</code>,
                    <code class="text-neutral-600 dark:text-neutral-400">engine.labels.&lt;key&gt;</code>
                </p>
            </div>

            {{-- Advanced Toggle --}}
            <button @click="showAdvanced = !showAdvanced"
                class="flex items-center gap-2 text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors">
            ...
            <div x-show="showAdvanced" x-collapse>
                <div class="space-y-6">
                    {{-- Resource Limits --}}
                    <div class="p-4 rounded-lg bg-white dark:bg-coolgray-200 border border-neutral-200 dark:border-transparent">
                        <h4 class="font-medium text-neutral-900 dark:text-white text-sm pb-3">Resource Limits</h4>
                    ...
                    {{-- Health Check --}}
                    <div class="p-4 rounded-lg bg-white dark:bg-coolgray-200 border border-neutral-200 dark:border-transparent">
                        <h4 class="font-medium text-neutral-900 dark:text-white text-sm pb-3">Health Check</h4>
                        <div class="space-y-3">
                    ...
                    {{-- Restart Policy --}}
                    <div class="p-4 rounded-lg bg-white dark:bg-coolgray-200 border border-neutral-200 dark:border-transparent">
                        <h4 class="font-medium text-neutral-900 dark:text-white text-sm pb-3">Restart Policy</h4>
        ...
        <div class="lg:col-span-1">
            <div class="sticky top-4">
                <div class="p-4 rounded-lg bg-white dark:bg-coolgray-200 border border-neutral-200 dark:border-transparent">
                    <h4 class="font-medium text-neutral-900 dark:text-white text-sm pb-3">Generated Deploy YAML</h4>
                    <pre class="p-3 rounded bg-neutral-900 dark:bg-black/50 border border-neutral-200 dark:border-coolgray-300 text-xs font-mono text-green-600 dark:text-green-400 overflow-x-auto max-h-[600px] overflow-y-auto whitespace-pre">{{ $yamlPreview }}</pre>
                    <p class="text-xs text-neutral-600 dark:text-neutral-500 mt-2">
