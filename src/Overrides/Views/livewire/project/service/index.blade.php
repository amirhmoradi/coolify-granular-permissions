{{-- =============================================================================
     ...
     Changes from the original are marked with "Coolify Enhanced:".
     Modification: Multi-port proxy UI for ServiceDatabase with coolify.proxyPorts label
     ============================================================================= --}}
<div>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                @else
                                    ...
                                    @endif
                                @endif
                                {{-- End Coolify Enhanced: Multi-port proxy section --}}
                            </div>
                        </div>
